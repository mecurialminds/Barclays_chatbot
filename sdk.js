	...
	this.createBox = function() {
		...
		var html =
			"<style>\n"
				...
				+ "." + this.prefix + "scroller { overflow-x:hidden;height:370px;width:330px; }\n"
...
function WebChatbotListener() {
	...
	this.createBox = function() {
		...
		html = html + this.style
			...
			+ "<div id='" + this.prefix + "box' class='" + this.prefix + "box' " + backgroundstyle + ">"
				+ "<div class='" + this.prefix + "boxmenu'>"
				+'<span style="float:left" class="botplatformuser-bot"><img src="https://i.imgur.com/nylTDuF.png" alt="Smiley face" width="110" height="20"></span>' 
		...
		if (this.showMenubar) {
			...
			if (this.allowSpeechRecognition == true || (this.allowSpeechRecognition == null && this.allowSpeech && SDK.isChrome())) {
				html = html
					+ "<a id='" + this.prefix + "speechRecognitionButton' onclick='return false;' href='#' title='Speech Recognition'><img id='" + this.prefix + "boxspeakrecognition' class='" + this.prefix + "boxbutton' src='https://i.imgur.com/cR5NJAM.png'></a>";
			}
		...
		if (document.getElementById(this.prefix + "boxspeak") != null) {
			document.getElementById(this.prefix + "boxspeak").addEventListener("click", function() {
				...
				if (self.speak) {
					SDK.initAudio();
					document.getElementById(self.prefix + "boxspeak").src = "https://i.imgur.com/cwYxotr.png";
					document.getElementById(self.prefix + "boxspeak2").src = "https://i.imgur.com/cwYxotr.png";
				} else {
		...
		if (document.getElementById(this.prefix + "boxspeakrecognition") != null) {
			...
			document.getElementById(this.prefix + "boxspeakrecognition").addEventListener("click", function() {
				...
				if (self.listen) {
					SDK.startSpeechRecognition();
					document.getElementById(self.prefix + 'boxspeakrecognition').src = "https://i.imgur.com/OicqL2a.png";
					document.getElementById(self.prefix + 'boxspeakrecognition2').src = "https://i.imgur.com/OicqL2a.png";
				} else {
					SDK.stopSpeechRecognition();
					document.getElementById(self.prefix + 'boxspeakrecognition').src = "https://i.imgur.com/cR5NJAM.png";
					document.getElementById(self.prefix + 'boxspeakrecognition2').src = "https://i.imgur.com/cR5NJAM.png";
				}
			});
